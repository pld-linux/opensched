...
Opensched jest narzędziem do zarządzania projektami. Przyjmuje jako
wejście plik opisujący projekt i generuje:

- tekstowy opis wygenerowanego planu przebiegu projektu,
- wykresy Gantta,
- grafy zależności

Tekstowy opis może być generowany w jednym lub więcej z formatów:
tekst, HTML, TeX. Wykresy Gantta i grafy zależności są generowane jako
